...
const ReadyToEarn = () => {
  // ইমেজের মতো দুই পাশে ছড়িয়ে থাকা কয়েনগুলোর জন্য পজিশন অ্যারে
  const leftCoins = [
  ...
  return (
    <section className="py-24 px-6 mt-10 mb-20 bg-slate-950 relative overflow-hidden w-full select-none">
      
      {/* ইমেজের দুই পাশের ভাসমান থ্রিডি কয়েন ও গ্লিটার ইফেক্ট */}
      <div className="absolute inset-0 max-w-7xl mx-auto pointer-events-none hidden lg:block">
        
        {/* বাম পাশের কয়েন গ্রুপ */}
      ...
      <div className="max-w-4xl mx-auto relative">
        ...
        {/* ইমেজের মতো দ্বিমুখী থিক নিওন গ্লো বর্ডার (Neon Outer Glow) */}
        ...
        {/* কার্ডের ভেতরের কন্টেন্ট এবং ব্যাকগ্রাউন্ড ওয়েব নেটওয়ার্ক */}
        <div className="relative bg-[#070b19] rounded-[22px] p-10 md:p-16 text-center overflow-hidden">
          
          {/* বাম পাশের সায়ান নেটওয়ার্ক গ্লো লাইন (Cyan Electric Lines) */}
          <div className="absolute inset-y-0 left-0 w-1/2 opacity-30 bg-[radial-gradient(ellipse_at_left,_var(--tw-gradient-stops))] from-cyan-500/40 via-transparent to-transparent pointer-events-none"></div>
          <svg className="absolute inset-y-0 left-0 w-1/2 h-full stroke-cyan-500/20 stroke-[1] fill-none opacity-40 pointer-events-none hidden sm:block" viewBox="0 0 100 100" preserveAspectRatio="none">
          ...
          {/* ডান পাশের ম্যাজেন্টা নেটওয়ার্ক গ্লো লাইন (Magenta Electric Lines) */}
          <div className="absolute inset-y-0 right-0 w-1/2 opacity-30 bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-fuchsia-500/40 via-transparent to-transparent pointer-events-none"></div>
          <svg className="absolute inset-y-0 right-0 w-1/2 h-full stroke-fuchsia-500/20 stroke-[1] fill-none opacity-40 pointer-events-none hidden sm:block" viewBox="0 0 100 100" preserveAspectRatio="none">
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm sm:text-base text-slate-300 max-w-2xl mx-auto mb-10 font-normal leading-relaxed opacity-90">
              Join thousands of users completing tasks and earning coins right now. Sign up takes less than a minute.
            </p>
            
            {/* ক্লিন হোয়াইট বাটন (Flat Premium White Button) */}
            <Link 
              to="/register" 
              className="inline-flex items-center justify-center px-7 py-3.5 bg-white text-slate-950 font-bold rounded-xl shadow-md hover:bg-slate-50 transition-all duration-300 hover:scale-[1.03] active:scale-[0.98] text-sm md:text-base"
            >
